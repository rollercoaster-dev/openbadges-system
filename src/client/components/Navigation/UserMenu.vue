    ...
    <div v-if="!isMobile" class="flex items-center space-x-3">
      ...
      <div v-else class="flex items-center space-x-3">
        ...
        >
          ...
          <span v-if="notificationCount > 0" class="absolute -top-0.5 -right-0.5 w-4 h-4 bg-red-500 text-white text-xs rounded-full flex items-center justify-center">
        ...
        <div class="relative">
          ...
          >
            ...
            >
              ...
              <div v-if="user.isAdmin" class="border-t border-gray-200 py-1">
      ...
      <div v-else class="space-y-2">
        ...
        <div class="space-y-1">
          <RouterLink
            ...
            :class="{ 'bg-gray-50 text-gray-900': isActiveRoute(item.to), 'text-gray-700': !isActiveRoute(item.to) }"
            :aria-current="isActiveRoute(item.to) ? 'page' : undefined"
          >
            <component :is="item.icon" class="w-4 h-4 mr-3" aria-hidden="true" />
            {{ item.label }}
        ...
        <!-- Admin section (if user is admin) -->
        <div v-if="user.isAdmin" class="border-t border-gray-200 pt-2 space-y-1">
