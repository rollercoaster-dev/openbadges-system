  ...
  <div class="max-w-md mx-auto">
    <div class="bg-white shadow-sm rounded-lg p-6 border border-gray-200">
      ...
      <div class="text-center mb-8">
        <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-blue-600 rounded-lg flex items-center justify-center mx-auto mb-4">
          <UserPlusIcon class="w-6 h-6 text-white" />
        </div>
        <h2 class="text-2xl font-bold text-gray-900">Create your account</h2>
        <p class="mt-2 text-sm text-gray-600">
          Already have an account? 
          <RouterLink to="/auth/login" class="font-medium text-blue-600 hover:text-blue-500 transition-colors">
            Sign in
          </RouterLink>
        </p>
      </div>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            />
            <p v-if="getFieldError('firstName')" id="firstName-error" class="mt-1 text-sm text-red-600">
          ...
          <div>
            ...
            />
            <p v-if="getFieldError('lastName')" id="lastName-error" class="mt-1 text-sm text-red-600">
        ...
        <div class="flex items-start">
          ...
          <label for="terms" class="ml-2 block text-sm text-gray-700">
            I agree to the 
            <button type="button" @click="$emit('showTerms')" class="text-blue-600 hover:text-blue-500 underline">
              Terms of Service
            </button>
            and 
            <button type="button" @click="$emit('showPrivacy')" class="text-blue-600 hover:text-blue-500 underline">
              Privacy Policy
            </button>
          </label>
        </div>
        ...
        >
          <span v-if="isLoading" class="flex items-center">
            ...
            {{ isPlatformAuthAvailable ? 'Setting up secure authentication...' : 'Creating account...' }}
          </span>
